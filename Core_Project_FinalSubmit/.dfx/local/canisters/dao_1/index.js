...
import { idlFactory } from './basic_dao_2.did.js';
export { idlFactory } from './basic_dao_2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BASIC_DAO_2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./basic_dao_2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the basic_dao_2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./basic_dao_2.did.js")._SERVICE>}
 */
export const basic_dao_2 = createActor(canisterId);
